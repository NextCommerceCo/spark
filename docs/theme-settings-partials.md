...
| --- | --- | --- | --- |
| `partials/section_hero.html` | Homepage > Hero | Full-width image hero with text overlay and CTA. | `show_hero`, `homepage_hero_image`, `homepage_hero_image_mobile`, `homepage_hero_heading`, `homepage_hero_subheading`, `homepage_hero_text_color`, `homepage_hero_text_align`, `homepage_hero_height`, `homepage_hero_overlay_color`, `homepage_hero_overlay_opacity`, `homepage_hero_link`, `homepage_hero_cta` |
| `partials/section_featured_product.html` | Homepage > Featured Product | Single product spotlight with image, copy, price, and CTA. | `show_featured_product`, `featured_product`, `featured_product_header`, `featured_product_description`, `featured_product_cta_text`, `featured_product_bg_color` |
| `partials/section_featured_products.html` | Homepage > Featured Products | Merchant-curated product grid. | `show_featured_products`, `featured_products`, `featured_products_header`, `featured_products_columns`, `featured_products_bg_color` |
| `partials/section_featured_categories.html` | Homepage > Featured Categories | Category image tile grid. | `show_featured_categories`, `featured_categories`, `featured_categories_header`, `featured_categories_columns`, `featured_categories_bg_color` |
| `partials/section_on_sale.html` | Homepage > On Sale | Merchant-curated sale product grid. | `show_on_sale`, `on_sale_products`, `on_sale_header`, `on_sale_columns`, `on_sale_bg_color` |
| `partials/section_promo_banner.html` | Homepage > Promo Banner | Full-width text and CTA promotion band. | `show_promo_banner`, `promo_banner_heading`, `promo_banner_subheading`, `promo_banner_cta_text`, `promo_banner_cta_url`, `promo_banner_bg_color`, `promo_banner_text_color` |
...
| `partials/header.html` | Navigation | Primary nav, logo, search, account, cart. | `main_menu`, `navbar_bg_color`, `navbar_link_color` |
...
| `partials/recommended_products.html` | Product Pages > Recommended Products | PDP recommended product section. | `show_recommended`, `recommended_products_header`, `recommended_products_header_align`, `recommended_products_columns`, `recommended_products_bg_color`, `recommended_products_card_bg` |
...
- Hero content position and content width.
- CTA outline/color controls for hero, featured product, featured products, and promo banner.
- Category tile overlay color/opacity and text color.
- Homepage/product-page custom CSS scoped settings.
- Header logo alignment and light/dark navbar mode.
